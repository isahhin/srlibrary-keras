...
from utils_SRCNN import load_test
...
image_size_trained = 57
label_size_trained = 41
...
def main():
    ...
    for loss in loss_lists:
       ...
       weight_filename = '../srcnn/S'+str(scale)+'Models/'+methodName+'/'+loss+'/model0020.hdf5'
       model = method.SRCNN()
       ...
       for i in range(n_img):
           ...
           bic = bic[padding: -padding, padding: -padding]
           gnd = gnd[padding: -padding, padding: -padding]
